...
&kp PG_UP,         &kp HOME,          &kp UP,            &kp END,           &kp INS,           U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
...
&kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,           U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              &kp INS,           &kp HOME,          &kp UP,            &kp END,           &kp PG_UP,         \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
U_WH_U,            U_WH_L,            U_MS_U,            U_WH_R,            U_NU,              U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
...
U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,            U_NU,              U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_MOUSE,     &u_to_U_SYM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_BTN3,            U_BTN1,            U_BTN2,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT \
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              U_NU,              U_WH_L,            U_MS_U,            U_WH_R,            U_WH_U,            \
...
U_RGB_HUI,         U_RGB_SAI,         &kp C_VOL_UP,      U_RGB_BRI,         U_RGB_TOG,         U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
...
U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         U_RGB_TOG,         U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              U_RGB_TOG,         U_RGB_EFF,         &kp C_VOL_UP,      U_RGB_HUI,         U_RGB_SAI,         \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         U_RGB_TOG,         \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              U_RGB_TOG,         U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              &kp LBKT,          &kp N7,            &kp N8,            &kp N9,            &kp RBKT,          \
...
&kp LBKT,          &kp N7,            &kp N8,            &kp N9,            &kp RBKT,          U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              &kp LBRC,          &kp AMPS,          &kp ASTRK,         &kp LPAR,          &kp RBRC,          \
...
&kp LBRC,          &kp AMPS,          &kp ASTRK,         &kp LPAR,          &kp RBRC,          U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
...
U_BOOT,            &kp F13,       &to_rus,     &to_eng,      U_NA,              &kp PSCRN,         &kp F7,            &kp F8,            &kp F9,            &kp F12,           \
...
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &kp PSCRN,         U_NA,              &to_eng,      &to_rus,     &kp F13,       U_BOOT,            \
