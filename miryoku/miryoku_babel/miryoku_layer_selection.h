...
#if !defined(MIRYOKU_LAYER_GAMER)
  #define MIRYOKU_LAYER_GAMER MIRYOKU_ALTERNATIVES_GAMER
#endif
#if !defined(MIRYOKU_LAYERMAPPING_GAMER)
  #define MIRYOKU_LAYERMAPPING_GAMER MIRYOKU_MAPPING
#endif
